...
<div class="klb-blog page-content">
	<div class="container">
		...
		<?php } elseif( get_theme_mod( 'clotya_blog_layout' ) == 'grid') { ?>
				<div class="row content-wrapper sidebar-right">
					<div class="col col-12 col-lg-9 content-primary">
						<div class="blog-posts klb-grid-style grid-<?php echo esc_attr( get_theme_mod( 'clotya_blog_grid_layout_column' ) ); ?>">
							<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
