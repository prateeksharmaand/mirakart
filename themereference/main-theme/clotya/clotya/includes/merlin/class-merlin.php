...
class Merlin {
	...
	protected function license() {
        if(clotya_get_registered_purchase_code()) {
	...
	protected function plugins() {
        if(empty(clotya_get_registered_purchase_code())) {
            echo "<p>".esc_html__('Please verify the purchase code first.','clotya')."</p>";
	...
	public function _ajax_activate_license() {
		...
		update_option( 'envato_purchase_code_35888977', $license_key );
