...
function clotya_register_theme() {
	...
	add_submenu_page( 'klbtheme_options', esc_html__('Theme Options', 'clotya'), esc_html__('Theme Options', 'clotya'), 'manage_options', 'customize.php?return=admin.php?page=klbtheme_options' );
}
...
function clotya_notice_for_activation() {
	...
	if(empty(clotya_get_registered_purchase_code())){
		...
		echo '<div class="notice notice-warning">
			...
			'<a href="' . admin_url('admin.php?page=klbtheme_options') . '">' . esc_html__( 'Enter Purchase Code', 'clotya' ) . '</a>') . '</p>
		</div>';
	}
}