jQuery(document).ready(function($) {
	...
	clotyaThemeModule.clotyaFlexThumb = function() {
		...
		if ($(".single-product-row .product-gallery-column").hasClass("vertical") && $(window).width() > 992) {
	...
	$(document).ready(function() {
		setTimeout(() => {
			clotyaThemeModule.clotyaFlexThumb();
		}, 110);
	});
