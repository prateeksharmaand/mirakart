...
ALTER TYPE order_status ADD VALUE IF NOT EXISTS 'COD_REFUSED';

ALTER TYPE order_item_status ADD VALUE IF NOT EXISTS 'ACCEPTED';
ALTER TYPE order_item_status ADD VALUE IF NOT EXISTS 'PACKED';
...
ALTER TYPE order_item_status ADD VALUE IF NOT EXISTS 'FAILED_DELIVERY';
ALTER TYPE order_item_status ADD VALUE IF NOT EXISTS 'COD_REFUSED';
